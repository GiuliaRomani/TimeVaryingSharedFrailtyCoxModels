...
int main(int argc, char *argv[]){
    try{
        ...
        // Read from the input file the id of the Time-Varying Shared Frailty Cox Model 
        // Check that the id method is not negative: otherwise, an exception is thrown
