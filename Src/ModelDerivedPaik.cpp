...
// Virtual method for extracting the parameters from the vector of parameters (using methods of the Eigen library)
...
void AdaptedPaikeaM::build_loglikelihood() noexcept{
    ...
    ll_group_paik = [this] (T::VectorXdr& v_parameters_, T::SharedPtrType indexes_group_){     
        // Extract variables and parameters from the vector and matrices
